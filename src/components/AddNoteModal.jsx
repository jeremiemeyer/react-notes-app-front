    ...
    return (
        ...
        >
          <div
            ...
            className="z-20 relative bg-slate-600 text-slate-900 min-w-[400px] md:min-w-[700px] px-10 pt-10 pb-6 rounded border border-slate-600 mb-[10vh]"
          >
            <button
              onClick={onClose}
            ...
            <NoteForm actionType="creer" onClose={onClose} />
          </div>
        </div>
      )
}